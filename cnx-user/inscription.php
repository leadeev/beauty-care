...
<body>
    ...
    <button>
        <a href="../index.php"><img class="logo" src="../view/images/llogo.png" alt=""></a> </button>
    <div class="login-form">
        ...
        <form action="inscription_traitement.php" method="post">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-block"><a href="index.php">Connexion</a></button>
            </div>
