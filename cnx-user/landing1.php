...
<body>
    ...
    <h2>DESTINATIONS PROPOSÉES PAR SÉJOUR MÉDICAL</h2>
    <button> Choisir Votre destination</button>


    <h3>TROUVER UN SEJOUR MEDICALE ADAPTER A VOTRE BUDGET</h3>
    <BUTTon>Contact & Devis</BUTTon>
    <SECTION>
        <H4>Confiez-nous votre projet médical</H4>
        <P>Un devis et un plan de traitement personnalisé sous 48 heures.</P>
        <button>DEMANDER UN DEVIS PERSONALISER </button>
    </SECTION>

    <h4>NOTRE CONTRAT </h4>
    <p>Partir à l’étranger afin de réaliser une intervention chirurgicale présente de nombreux avantages. <br>
        Pour que cette expérience reste toujours un succès, un contrat d’engagement nous lie.</p>
    <section class="vos"> VOS DEVOIRS</section>
    <P>Données médicales <br>

        Nous transmettre des données médicales exactes</P>
    <P>Nous questionner <br>
        Posez-nous toutes vos questions, même si vous vous dîtes que cela ne se demande pas</P>


    <section class="nos">NOS DEVOIRS</section>
    <p>Fiabilité <br>
    ...
    <p> Disponibilité 24/7 <br>
        Etre disponible pour vous jour et nuit durant votre séjour</p>
    <p> Au long terme <br>
        S’assurer de la réussite du traitement dans la durée</p>
