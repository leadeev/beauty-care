...
--
-- Structure de la table `sercretariat`
--

CREATE TABLE `sercretariat` (
  `id_secretariat` int(11) NOT NULL,
...
--
-- Index pour la table `sercretariat`
--
ALTER TABLE `sercretariat`
...
--
-- AUTO_INCREMENT pour la table `sercretariat`
--
ALTER TABLE `sercretariat`
...
--
ALTER TABLE `secretaire`
  ADD CONSTRAINT `secretaire_ibfk_1` FOREIGN KEY (`id_secretariat`) REFERENCES `sercretariat` (`id_secretariat`);

--
-- Contraintes pour la table `sercretariat`
--
ALTER TABLE `sercretariat`
  ADD CONSTRAINT `sercretariat_ibfk_1` FOREIGN KEY (`id_service`) REFERENCES `services` (`id_service`);
