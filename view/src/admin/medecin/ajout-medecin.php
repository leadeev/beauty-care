                ...
                <div class="column">
                    <form>
                        ...
                        <div class="field has-addons">
                            <p class="control">
                                <input type="text" placeholder="Prénom" name="prenom" class="input" aria-required="true"
                                    aria-invalid="false">
                            </p>
                        </div>
                        ...
                        <div class="field has-addons">
                            <p class="control">
                                <input type="text" placeholder="Nom" name="nom" class="input" aria-required="true"
                                    aria-invalid="false">
                            </p>
                        </div>
                        ...
                        <div class="field has-addons">
                            <p class="control">
                                <input type="date" placeholder="Date de naissance" name="dnm" class="input"
