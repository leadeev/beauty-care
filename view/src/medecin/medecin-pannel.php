...
<body>
    ...
    <section class="section startups has-text-centered">
        <div style="font-size:16px; font-weight:bold;" class="container is-narrow">
                    ...
                    <div class="column level-item">
                        <div class="box"><img class="logo" src="../../images/rdv.png"><br>
                            <a style="font-size:16px; font-weight:bold;"
                                class="button is-info is-outlined is-rounded">LISTE RENDEZ-VOUS</a>
                        </div>
                    </div>
                    <div class="column level-item">
                        <div class="box"><img class="logo" src="../../images/planning.png"><br>
                            <a style="font-size:16px; font-weight:bold;"
                                class="button is-info is-outlined is-rounded">MON PLANNING</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script async type="text/javascript" src="../../js/CLOSEbutton.js"></script>
</body>
